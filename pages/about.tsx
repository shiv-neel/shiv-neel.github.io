...
const About = () => {
	return (
		<Box
			className='mt-28 px-20 justify-center mx-auto max-w-5xl'
		...
		>
			...
			<Box>
				<p className='mt-2 leading-relaxed'>
					...
					<br />
					<br />
					I&apos;m currently in my final semester of my computer science
					bachelor&apos;s degree at Iowa State University. I currently intern at
					Workiva, Inc. as a Software Engineer, and have a total of{' '}
					<strong>2 years work experience</strong>. I plan to get a
					...
					future in which vehicles are 100% safe for us, and sustainable for our
					grandchildren, without compromise on the pursuit of driving. While
					many may dismiss this vision as naive optimism, I would argue that we
					are already witnessing the beginnings of this vision&apos;s
					manifestation.
					<br />
					<br />
					...
					Not to mention, many of these vehicles are way quicker and look even
					cooler than their predecessors!
					<br />
					<br />
